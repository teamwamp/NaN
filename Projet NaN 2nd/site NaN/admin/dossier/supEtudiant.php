      ...
      <div id='content'>
        <div class='panel panel-default'>
         <div class='panel-heading'>
            ...
            Supprimer de l'étudiant
          </div>
          <div class='panel-body'>
            <form class="form" action="supEtudiant.php" method="post" role="form">
                <input type="hidden" name="id" value="<?php echo $id; ?>" />
                <p class="alert alert-warning">Etes vous sûr de vouloir supprimer cet étudiant ?</p>
                <div class='form-actions'>
                  <button class='btn btn-danger' type='submit'>Oui</button>
                  <a class='btn' href='etudiants.php'>Non</a>
                </div>
            </form>
          </div>
        </div>
