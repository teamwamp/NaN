		...
		<div class="col-md-4 top-header-agile-right">
			...
			<div class="col-md-4 top-header-agile-left">
				<ul class="num-w3ls">
					...
					<li><a href="contact.phpl" data-hover="Mail Us">Contact</a></li>
				</ul>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav">
							<li class="active"><a href="index.php" data-hover="Home">Accueil</a></li>
							<li><a href="about.php" data-hover="About Us">A propos</a></li>
							<li>
								<a href="gallery.php" data-hover="Gallery">Communauté</a>
							</li>
							...
							<li><a href="blog.php" data-hover="Blog">Actualités</a></li>
...
<!-- copy-right -->
			<div class="copyright-wthree">
				<p>&copy; 2018 . Organisme à but non lucratif | Design by Teem Wamp <a href="http://w3layouts.com/"> Not a Number </a></p>
			</div>
<!-- //copy-right -->
